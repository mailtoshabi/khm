...
use App\Http\Controllers\VtransactSecurityController as VtransactSecurity;
use App\Http\Controllers\HTTPPostController as HTTPPost;
use App\Http\Controllers\ReqMsgDTOController as ReqMsgDTO;
use Utility;

class AWLMEAPIController extends Controller
{
    /**
    ...
    function getTransactionStatus($mid, $orderid, $pgmetrn,$enc_key)
    {
        ...
        $qpURL=Utility::GET_TRANS_STATUS;
    ...
    function cancelTransaction($reqMsgDTO)
    {
        ...
        try
        {
            ...
            $qpURL=Utility::CANCEL_TRANS_API;
    ...
    {   //$reqMsgDTO = new ReqMsgDTO();
        ...
        try
        {
            ...
            $qpURL=Utility::REFUND_TRANS_API;
