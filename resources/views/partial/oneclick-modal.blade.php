<div class="modal fade" id="oneClickModal">
    <div class="modal-dialog ">
        ...
        <form class="login modal-content" id="oneclick_form" action="{{ route('product.oneclick.purchase') }}" method="POST" role="form" data-plugin="ajaxForm">
