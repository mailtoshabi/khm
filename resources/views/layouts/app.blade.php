...
<head>
    ...
    @else
    <title>{{ Utility::settings('site_title') }} | {{ config('app.name') }}</title>
    @endif
...
<div class="main">
    ...
    {{-- @include('partial.upload-prescrip-modal') --}}
    @include('partial.transfer-payment-modal')
    @stack('page_html')
</div>
<!-- main end -->
