...
<div class="wrapper">
    ...
    <form action="{{ route('meTrnPay') }}" method="post">
        {{ csrf_field() }}
        <table>
            <tr>
                ...
                <td><input type="text" value="10000" id="amount" name="amount"></td>
            ...
            <tr>
                ...
                <td><input type="text" value="NA" id="recurPeriod" name="recurPeriod"></td>
            ...
            <tr>
                ...
                <td><input type="text" name="responseUrl" id="responseUrl" value="{{ route('test_pay_success') }}" /></td>
            </tr>
            <tr>
                <td>
