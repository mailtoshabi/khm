@extends('layouts.app')
@section('title',$message) {{--$product->name--}}
@section('description','')
@section('keywords','')
@section('content')
                        ...
                        <div>
                            <center>
                                ...
                                <h5>Order number: #{{ $sale->order_no }}</h5>
                                    ...
                                    <p class="text-success"><strong>Transfer INR {{ $sale->sub_total + $sale->delivery_charge }} by using either of the following methods and Update your UTR Number below.</p>
                                    <p><strong>
                                ...
                                @if($sale->is_paid)
                                    ...
                                    <h5><i class="fa fa-download text-primary"></i> <a class="text-primary" target="_blank" href="{{ route('bill.download.specific',[$sale->id,'download'=>'invoice']) }}">Download Bill</a></h5>
                                @endif
                                <hr />
                            </center>
                        </div>
        ...
        $('#submit_utr').click(function(e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    $('#msg-bg').fadeIn().html('<p class="text-success">UTR number updated successfully. We will check your concern and contact you soon.</p>');
