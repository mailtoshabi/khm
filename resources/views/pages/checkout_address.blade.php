                    ...
                    <div class="panel panel-info" style="margin-top: 10px;">
                        ...
                        <div id="dvEmptycontainer01">
                            <div class="panel-body">
                                <form class="login" action="{{ route('checkout.address.store') }}" method="post" id="address_form_chkout" data-laddabutton="#address-submit" role="form" data-plugin="ajaxForm">
                                    <div class="row">
...
<script>
    $(document).ready(function() {
        ...
        $('#dvEmptycontainer01').on('af.success','#address_form_chkout',function(e,data) {
            window.location.replace("{{ route('checkout.payment_options') }}");
        });
