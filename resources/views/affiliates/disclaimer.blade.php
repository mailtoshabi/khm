...
@section('title','Disclaimer Policy')
@section('description','')
@section('keywords','')
@section('content')
        ...
        <div class="container"> <!---->
            <div class="row">
                <div role="tabpanel">
                    ...
                    <div class="col-sm-12">
                        <h3 class="">Disclaimer Policy</h3>
                    </div>

                    <div class="col-sm-12">
                        <p>If you require any more information or have any questions about our
                            site's disclaimer, please feel free to contact us by email at
                            keralahealthmart@gmail.com</p>

                        <h4>Disclaimers for Kerala Health Mart</h4>

                        <p>All the information on this website - www.keralahealthmart.com - is
                            published in good faith and for general information purpose only.
                            Kerala Health Mart does not make any warranties about the
                            completeness, reliability and accuracy of this information. Any action
                            you take upon the information you find on this website (Kerala Health
                            Mart), is strictly at your own risk. Kerala Health Mart will not be
                        ...
                        <p>Please be also aware that when you leave our website, other sites
                        ...
                        <p>Should we update, amend or make any changes to this document, those
                            changes will be prominently posted here.</p>
