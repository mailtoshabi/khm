                    ...
                    <div class="col-sm-12">
                        @if(isset($_GET['error_msg']))
                            <p class="delete_accnt_warning">
                                You have active sales entries, which is not closed or cancelled. Either you wait to receive the products or cancel the order by going <a href="{{ route('affiliate.myorders',$affiliate_slug) }}">My Orders</a> page. Contact us at support@keralahealthmart.com if you face any problem.
                            </p>
                        @endif
                        <h4>
