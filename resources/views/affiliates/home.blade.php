                        ...
                        <div class="col-md-12" >
                            <div class="col-md-2 col-lg-2 col-sm-12 col-xs-12">
                                <div class="sm-bg home_product_valign">
                                    ...
                                    <div class="col-md-12 col-xs-4 product_name text-center" style="margin-top: 1px;">
                                        <button class="btn btn-primary btn-md hidden-xs hidden-sm" onclick="location.href='{{ route('affiliate.category.all',[$affiliate_slug]) }}'">View All</button>
                                        <button class="btn btn-primary btn-sm hidden-md hidden-lg" onclick="location.href='{{ route('affiliate.category.all',[$affiliate_slug]) }}'">View All</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-10 col-lg-10 col-sm-12 col-xs-12">
                                        ...
                                        @foreach($mainCategories as $mainCategory)
                                            @if(!empty($mainCategory->products))
                                                <div class="item {{ $main_catNo==1 ? 'active' : '' }}">
                                                    <div class="col-md-3 col-lg-3 col-xs-6 col-sm-3 hm_prod_container">
                                                        <center>
                                                            <a href="{{ route('affiliate.all.slug',[$affiliate_slug, $mainCategory->slug]) }}" class="product_item" title="{{ $mainCategory->name }}">
                    ...
                    <div class="col-md-12" >
                        <div class="col-md-2 col-lg-2 col-sm-12 col-xs-12">
                            <div class="sm-bg home_product_valign">
                                ...
                                <div class="col-md-12 col-xs-4 product_name text-center" style="margin-top: 1px;">
                                    <button class="btn btn-primary btn-md hidden-xs hidden-sm" onclick="location.href='{{ route('affiliate.all.slug',[$affiliate_slug, $mainCategory->slug]) }}'">View All</button>
                                    <button class="btn btn-primary btn-sm hidden-md hidden-lg" onclick="location.href='{{ route('affiliate.all.slug',[$affiliate_slug, $mainCategory->slug]) }}'">View All</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-10 col-lg-10 col-sm-12 col-xs-12">
