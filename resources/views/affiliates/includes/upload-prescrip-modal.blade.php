<div class="modal fade" id="myPrescriptionModal">
    <div class="modal-dialog ">
        <form class="login modal-content" action="{{ route('affiliate.product.prescription',$affiliate_slug) }}" method="post" id="prescription_form" role="form" data-plugin="ajaxForm" autocomplete="off" enctype="multipart/form-data">
