    ...
    <div class="container">
        <div style="padding:5px 0;">
            ...
            <div id="scroll-device" class="row row2">
                <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12" style="padding-right: 12px;">
                    <h2 style="margin:0px;">
                        <span class="smallnav menu">
                            <a href="{{ route('all.slug',$affiliate_slug) }}" > <img style="margin-top: -8px;" class="khm_logo" src="{{ empty($affiliate->image) ? asset('images/no-image.jpg') : asset($affiliate->image['original']) }}" width="160" alt="{{ $affiliate->user->name }}"/></a>
                    ...
                    <h1 style="margin:0;  margin-top: -13px;">
                        <span class="largenav">
                            <a href="{{ route('all.slug',$affiliate_slug) }}"><img class="khm_logo" src="{{ empty($affiliate->image) ? asset('images/no-image.jpg') : asset($affiliate->image['original']) }}" width="160" alt="{{ $affiliate->user->name }}" />
                ...
                <div class="khm-navbar-search smallsearch col-lg-6 col-md-4 col-sm-4 col-xs-10">
                    <div class="row">
                        <form action="{{ route('affiliate.services_post',$affiliate_slug) }}" method="POST" name="form-search" id="form-search" autocomplete="off">
                            {!! csrf_field() !!}
                            <div class="row">
