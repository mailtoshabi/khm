        ...
        <form class="login modal-content" action="" method="post" id="payment_utr_form" role="form" data-plugin="ajaxForm" autocomplete="off" enctype="multipart/form-data">
            <div class="modal-body row" style="background: white;">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12" style="padding: 12px 6%; background: #2874f0;">
                    ...
                    <br>
                    @if(!empty($affiliate->contact_whatsapp))
                    <div id="" class="form-group" >
                        <a href="https://api.whatsapp.com/send?phone=91{{ str_replace(' ','',$affiliate->contact_whatsapp) }}" target="_blank" id="submit_utr" style="color: yellow; font-weight: bold; font-size: 17px; text-decoration: none; "><i class="fa fa-whatsapp"></i> <u>Share payment details on Whatsapp</u></a>
                    </div>
                    @endif
                </div>
